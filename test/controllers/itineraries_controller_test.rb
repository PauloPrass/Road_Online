...
class ItinerariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create itinerary" do
    assert_difference('Itinerary.count') do
      post itineraries_url, params: { itinerary: { bus_lines_id: @itinerary.bus_lines_id, latitude: @itinerary.latitude, longuitude: @itinerary.longuitude } }
    end
  ...
  test "should update itinerary" do
    patch itinerary_url(@itinerary), params: { itinerary: { bus_lines_id: @itinerary.bus_lines_id, latitude: @itinerary.latitude, longuitude: @itinerary.longuitude } }
