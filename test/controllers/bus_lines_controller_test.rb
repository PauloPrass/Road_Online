...
class BusLinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bus_line" do
    assert_difference('BusLine.count') do
      post bus_lines_url, params: { bus_line: { code: @bus_line.code, name: @bus_line.name } }
    end
  ...
  test "should update bus_line" do
    patch bus_line_url(@bus_line), params: { bus_line: { code: @bus_line.code, name: @bus_line.name } }
